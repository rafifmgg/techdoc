...
public class OcmsOffenceNoticeDetail extends BaseEntity {
    ...
    private String invalidCoupon3Condition;
    ...
    @JsonSerialize(using = ToStringSerializer.class)
    private BigDecimal invalidCoupon3Denom;

    @Column(name = "invalid_coupon_no_3", length = 9)
    private String invalidCoupon3No;
    ...
    // NOT USED NOW - Column doesn't exist in database
    ...
    // NOT USED NOW
    // @Column(name = "rep_subsystem_label", length = 8)
    // private String repSubsystemLabel;

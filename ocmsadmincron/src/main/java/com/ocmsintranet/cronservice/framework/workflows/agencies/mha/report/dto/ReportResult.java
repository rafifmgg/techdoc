package com.ocmsintranet.cronservice.framework.workflows.agencies.mha.report.dto;

import lombok.Data;

/**
 * Result wrapper for MHA report generation operations.
...
public class ReportResult {
    ...
    public String getDetailedMessage() {
        ...
        if (totalCount == 0) {
            return "No MHA report records found for " + reportDate + " - report generation skipped";
        }

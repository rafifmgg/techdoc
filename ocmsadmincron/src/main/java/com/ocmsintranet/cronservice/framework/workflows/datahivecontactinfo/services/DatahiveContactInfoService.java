...
/**
 * Service interface for Datahive Contact Info Daily report operations.
 * 
 ...
 * - Both methods ultimately delegate to the DatahiveContactInfoReportJob for the actual report generation
 */
public interface DatahiveContactInfoService {
    
    /**
     * Execute the Datahive Contact Info Daily report generation job.
     *

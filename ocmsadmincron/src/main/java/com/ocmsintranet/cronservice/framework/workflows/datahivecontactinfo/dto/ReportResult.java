package com.ocmsintranet.cronservice.framework.workflows.datahivecontactinfo.dto;

import lombok.Data;

/**
 * Result wrapper for DataHive contact info report generation operations.
...
public class ReportResult {
    ...
    public String getDetailedMessage() {
        ...
        if (totalCount == 0) {
            return "No DataHive contact info records found for " + reportDate + " - report generation skipped";
        }

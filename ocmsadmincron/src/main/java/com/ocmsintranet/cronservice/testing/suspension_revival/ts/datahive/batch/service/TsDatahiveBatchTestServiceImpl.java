...
import com.ocmsintranet.cronservice.testing.suspension_revival.ts.datahive.batch.helpers.TsDatahiveBatchStepExecutionHelper;
...
@Slf4j
@Service
public class TsDatahiveBatchTestServiceImpl implements TsDatahiveBatchTestService {

    @Autowired
    private TsDatahiveBatchStepExecutionHelper stepExecutionHelper;

    private static final String SCENARIO_FILE = "testing/suspension_revival/data/ts_datahive_batch_scenarios.json";

    @Override
    public SuspensionRevivalTestResponse executeTsDatahiveBatchTest(SuspensionRevivalTestRequest request) {
        log.info("Executing TS-DataHive Batch test: details={}, triggerApi={}",
        ...
        log.info("TS-DataHive Batch test completed: {} steps executed", response.getSteps().size());
        return response;
    }

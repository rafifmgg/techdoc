...
import com.ocmsintranet.cronservice.testing.suspension_revival.ps.toppan.helpers.PsToppanStepExecutionHelper;
...
@Slf4j
@Service
public class PsToppanTestServiceImpl implements PsToppanTestService {

    @Autowired
    private PsToppanStepExecutionHelper stepExecutionHelper;

    private static final String SCENARIO_FILE = "testing/suspension_revival/data/ps_toppan_scenarios.json";

    @Override
    public SuspensionRevivalTestResponse executePsToppanTest(SuspensionRevivalTestRequest request) {
        log.info("Executing PS-Toppan test: details={}, triggerApi={}",
        ...
        log.info("PS-Toppan test completed: {} steps executed", response.getSteps().size());
        return response;
    }

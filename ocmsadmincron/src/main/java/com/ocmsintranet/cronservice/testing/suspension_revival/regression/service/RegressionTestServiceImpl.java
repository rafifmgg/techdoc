...
import com.ocmsintranet.cronservice.testing.suspension_revival.regression.helpers.RegressionStepExecutionHelper;
...
public class RegressionTestServiceImpl implements RegressionTestService {
    ...
    @Autowired
    private RegressionStepExecutionHelper stepExecutionHelper;

    private static final String SCENARIO_FILE = "testing/suspension_revival/data/regression_scenarios.json";

    @Override
    public SuspensionRevivalTestResponse executeRegressionTest(SuspensionRevivalTestRequest request) {
        log.info("Executing Regression test: details={}, triggerApi={}",
        ...
        log.info("Regression test completed: {} steps executed", response.getSteps().size());
        return response;
    }

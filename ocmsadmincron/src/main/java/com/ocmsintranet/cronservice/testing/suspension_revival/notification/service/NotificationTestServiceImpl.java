...
import com.ocmsintranet.cronservice.testing.suspension_revival.notification.helpers.NotificationStepExecutionHelper;
...
public class NotificationTestServiceImpl implements NotificationTestService {
    ...
    @Autowired
    private NotificationStepExecutionHelper stepExecutionHelper;

    private static final String SCENARIO_FILE = "testing/suspension_revival/data/notification_scenarios.json";

    @Override
    public SuspensionRevivalTestResponse executeNotificationTest(SuspensionRevivalTestRequest request) {
        log.info("Executing Notification test: details={}, triggerApi={}",
        ...
        log.info("Notification test completed: {} steps executed", response.getSteps().size());
        return response;
    }

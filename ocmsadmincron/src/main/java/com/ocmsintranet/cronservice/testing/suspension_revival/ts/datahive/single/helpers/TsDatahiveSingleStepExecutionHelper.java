package com.ocmsintranet.cronservice.testing.suspension_revival.ts.datahive.single.helpers;
...
@Slf4j
@Component
public class TsDatahiveSingleStepExecutionHelper extends SuspensionStepExecutionHelper {
    ...
    public TestStepResult executeStep2TriggerProcess(boolean triggerApi, List<Map<String, Object>> scenarios) {
        try {
            log.info("Step 2: Trigger DataHive Single download process (triggerApi={})", triggerApi);

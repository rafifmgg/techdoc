...
import com.ocmsintranet.cronservice.testing.suspension_revival.auto_revival.helpers.AutoRevivalStepExecutionHelper;
...
@Slf4j
@Service
public class AutoRevivalTestServiceImpl implements AutoRevivalTestService {

    @Autowired
    private AutoRevivalStepExecutionHelper stepExecutionHelper;

    private static final String SCENARIO_FILE = "testing/suspension_revival/data/auto_revival_scenarios.json";

    @Override
    public SuspensionRevivalTestResponse executeAutoRevivalTest(SuspensionRevivalTestRequest request) {
        log.info("Executing Auto-Revival test: details={}, triggerApi={}",
        ...
        log.info("Auto-Revival test completed: {} steps executed", response.getSteps().size());
        return response;
    }

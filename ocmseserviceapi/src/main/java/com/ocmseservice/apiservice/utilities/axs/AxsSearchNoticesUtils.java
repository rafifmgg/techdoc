...
import com.ocmseservice.apiservice.utilities.parkingfines.PaymentFlagUtil;
...
@Component
public class AxsSearchNoticesUtils {
    ...
    @Autowired
    public AxsSearchNoticesUtils(EocmsValidOffenceNoticeRepository eocmsValidOffenceNoticeRepository,
        ...
        AxsSearchNoticesUtils.userMessageRepository = eocmsUserMessageRepository;
    ...
    public SearchParkingNoticeDTO checkNotices(String noticeNumber) {
        ...
        if (entity == null) {
            ...
            dto.setErrorMessage(AxsSearchNoticesUtils.getMessage(errorCode,
        ...
        dto.setSeachBy("NN");
        dto.setNoticeDateAndTime(entity.getNoticeDateAndTime());
        dto.setCarparkName(entity.getCarparkName());
        ...
        AxsSearchNoticesUtils.WebTxnAuditValidator webTxnValidator =
                new AxsSearchNoticesUtils.WebTxnAuditValidator(this.eocmsWebTxnDetailRepository, this.eocmsUserMessageRepository);
    ...
    public static class WebTxnAuditValidator {
        ...
        public SearchParkingNoticeDTO validateTransaction(SearchParkingNoticeDTO dto) {
            ...
            if (isWithin300Seconds(txnTime)) {
                result.setErrorMessage(AxsSearchNoticesUtils.getMessage(
                        "E11",

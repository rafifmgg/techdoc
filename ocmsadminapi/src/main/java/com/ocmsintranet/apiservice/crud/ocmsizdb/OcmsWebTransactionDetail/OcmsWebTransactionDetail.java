...
/**
 * Entity representing the ocms_web_txn_detail table.
 * Stores information related to web transaction details.
 */
@Entity
@Table(name = "ocms_web_txn_detail", schema = "ocmsizmgr")
@IdClass(OcmsWebTransactionDetailId.class)
@Getter
@Setter
@NoArgsConstructor
public class OcmsWebTransactionDetail extends BaseEntity {

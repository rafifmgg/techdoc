...
/**
 * Composite primary key class for OcmsWebTransactionDetail entity.
 * Primary key consists of receipt_no and offence_notice_no.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class OcmsWebTransactionDetailId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        OcmsWebTransactionDetailId that = (OcmsWebTransactionDetailId) o;

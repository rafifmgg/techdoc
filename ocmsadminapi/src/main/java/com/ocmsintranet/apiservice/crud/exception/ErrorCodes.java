...
public enum ErrorCodes {
    ...
    SUCCESS("OCMS-2000", "Operation completed successfully"),
    CREATED("OCMS-2001", "Resource created successfully"),
    ACCEPTED("OCMS-2002", "Request accepted for processing"),
    NO_CONTENT("OCMS-2004", "Request processed successfully, no content to return"),
    PARTIAL_CONTENT("OCMS-2006", "Partial content returned"),
    IM_USED("OCMS-2026", "Notice no Already exists"),

    //REP Response
    REP_SUCCESS("OCMS-2000", "OK"),
    MISSING_MANDATORY("OCMS-4000","Invalid input format or failed validation"),
    READY_USED("OCMS-4000", "Notice no Already exists"),
    REP_UNAUTHORIZED("OCMS-4001", "Unauthorized Access"),
